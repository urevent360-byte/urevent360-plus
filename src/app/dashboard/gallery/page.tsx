...
import { Download, DownloadCloud, Eye } from 'lucide-react';
...
export default function GalleryPage() {
    ...
    return (
        <div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t.eventName[language]}</CardTitle>
                            ...
                            <div key={photo.id} className="relative group overflow-hidden rounded-lg shadow-md aspect-square">
                                ...
                                <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div className="flex items-center gap-2">
                                        <Button variant="outline" size="sm" onClick={() => setSelectedImage(photo.imageUrl)}>
