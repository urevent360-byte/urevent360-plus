    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Welcome, {user?.displayName || 'Host'}!</h1>
                ...
                <div className="space-y-6">
                    <Card>
                        ...
                        <CardContent className="grid grid-cols-2 gap-4">
                           <Button asChild variant="outline"><Link href="/app/gallery"><GalleryHorizontal className="mr-2"/> View Gallery</Link></Button>
                           <Button asChild variant="outline"><Link href="/app/timeline"><ListMusic className="mr-2"/> Event Timeline</Link></Button>
                           <Button asChild variant="outline"><Link href="/app/payments"><CreditCard className="mr-2"/> View Payments</Link></Button>
                           <Button asChild variant="outline"><Link href="/app/services"><Calendar className="mr-2"/> My Services</Link></Button>
                        </CardContent>
                    </Card>
                </div>
            </div>
                 ...
                 <Card>
                    ...
                    <CardContent>
                         <ul className="space-y-3 list-disc list-inside text-muted-foreground">
                            ...
                            <li>Review your event timeline by August 15, 2024.</li>
